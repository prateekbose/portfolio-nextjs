let BlogsData = {
    "react-spring": [
        ...
        {type: "section", content: [
          ...
          {type: "code-text", textback: "To use the ", code: "useSpring", textfront: " hook in out project, we import the hook and animated the react-spring library. We also import the d3-ease library, though it can be ignored if you want to use other easing functions."},
