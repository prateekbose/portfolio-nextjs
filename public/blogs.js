let BlogsData = {
    "react-spring": [
        ...
        {type: "section", content: [
          ...
          {type: "text", text: "While React Spring provides both hook-based and component-based APIs, for the article we’ll exclusively look at the hook-based API for all the animations."},
        ...
        {type: "section", content: [
          ...
          {type: "code-text", textback: "To use the ", code: "useSpring", textfront: " hook in our project, we import the hook and animated from the react-spring library. We also import the d3-ease library, though it can be ignored if you want to use other easing functions."},
        ...
        {type: "section", content: [
          ...
          {type: "sub-head", text: "Animating Background"},
          ...
          {type: "code-text", textback: "This would add the animation to the background ", code: "<div>", textfront: " which would increase int height to cover 50% of the viewport height. Notice the config settings, we are using easings and duration instead of physics based animations, as this allows us to set the duration, which is not possible with spring based animations."},
          ...
          {type: "text", text: "This would give us the required background with the animation as shown below"},
          {type: "code-sandbox", url: "https://codesandbox.io/embed/wild-flower-xi3f9?fontsize=14&hidenavigation=1&theme=dark&view=preview"},
          {type: "sub-head", text: "Animating Text"},
          ...
          {type: "sub-head", text: "Making the animation complex"},
          {type: "code-text", textback: "The animation could be taken further by creating individual reveal animations for each word by a loop and modifying the ", code: "useSpring", textfront: " hook in a manner as shown below"},
          ...
          {type: "code-text-mul", text: [
            ...
            {type: "text", text: " function splits the string into characters using the delimiter passed as the parameter, which in this case is "},
            {type: "code", text: "\" \""},
            {type: "text", text: " character (whitespace character). Which would create an array of words, over which we iterate to create individual elements with their own animations, with the offset passed as the parameter in each iteration to maintain an order of reveal. We use the "},
            {type: "code", text: "&nbsp;"},
            {type: "text", text: " unicode character to mention a whitespace as any whitespaces mention as a JavaScript literal is discarded."}
          ]},
